    ...
    <div class="container">
        <div class="forms">
            <div class="form login">
                <span class="title">Đăng nhập người dùng</span>
                <form id="submit-login" method="post" action="<?php echo $actual_link ?>/user/login_processing">
                    <?php
                ...
                <div class="login-signup">
                    <span class="text">Chưa có tài khoản?
                        <a href="<?php echo $actual_link ?>/user/register" class="text signup-link">Đăng kí ngay</a>
                    </span>
                </div>
            </div>
        </div>
